...
[Serializable]
[PostProcess(typeof(PostProcessOutlineRenderer), PostProcessEvent.BeforeStack, "PGATR/Post Process Outline")]
...
public sealed class PostProcessOutlineRenderer : PostProcessEffectRenderer<PostProcessOutline>
{
    ...
    {
        var sheet = context.propertySheets.Get(Shader.Find("Hidden/PGATR/Outline Post Process"));
